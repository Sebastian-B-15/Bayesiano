...
Sean unas variables aleatorias permutables $x_1, ..., x_{n+m}$, entonces a la densidad $p(x_{n+1}, ..., x_m|x_1, ..., x_n) = \int_{\Theta} \left( \prod_{i=n+1}^{n+m} p(x_i|\theta) \right) p(\theta|x_1, ...,x_n) d\theta$.